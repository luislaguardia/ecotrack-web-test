...
const News = () => {
  ...
  const fetchNews = async () => {
    try {
      const res = await axios.get("https://ecotrack-back.onrender.com/news");
  ...
  const handleSubmit = async () => {
    try {
      if (editingNewsId) {
        await axios.put(`https://ecotrack-back.onrender.com/news/${editingNewsId}`, formData);
      } else {
        await axios.post("https://ecotrack-back.onrender.com/news", formData);
      }
      fetchNews();
  ...
  const handleDelete = async (id) => {
    if (confirm("Are you sure you want to delete this news?")) {
      try {
        await axios.delete(`https://ecotrack-back.onrender.com/news/${id}`);
